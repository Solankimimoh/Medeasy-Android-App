    ...
    private void initView() {
        ...
        databaseReference.child(AppConfig.FIREBASE_DB_MEDICAL)
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                nameEd.setText(medicalModel.getName());
                emailEd.setText(medicalModel.getEmail());
                passwordEd.setText(medicalModel.getName());
                mobileEd.setText(medicalModel.getMobile());
                addressEd.setText(medicalModel.getAddress());
                typesStockEd.setText(medicalModel.getTypes());
                licenseEd.setText(medicalModel.getLicense());
                progressDialog = new ProgressDialog(ProfileActivity.this);
            }
    ...
    public void onClick(View v) {
        ...
        if (email.isEmpty() || password.isEmpty() || name.isEmpty()
            ...
            databaseReference.child(AppConfig.FIREBASE_DB_MEDICAL)
                    ...
                    .setValue(new MedicalModel(name, email, password, mobile, address, types, license), new DatabaseReference.CompletionListener() {
                        @Override
